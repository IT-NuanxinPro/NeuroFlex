...
export const itemPool = [
  ...
  { name: '披萨', category: '食品', price: 30, icon: '🍕' },
  { name: '寿司', category: '食品', price: 40, icon: '🍣' },
  { name: '冰淇淋', category: '食品', price: 10, icon: '🍦' },
  // 文具
  ...
  { name: '橡皮', category: '文具', price: 1, icon: '🩹' },
  { name: '剪刀', category: '文具', price: 12, icon: '✂️' },
  // 日用品
  ...
  { name: '肥皂', category: '日用品', price: 6, icon: '🧼' },
  { name: '洗发水', category: '日用品', price: 25, icon: '🧴' },
  // 电子产品
